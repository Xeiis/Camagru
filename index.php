    ...
    <div class="container">
        ...
        <center>
            <div class="connexion">
                ...
                <a href="inscription.php" id="href" style="font-size:12px; color:#000; text-decoration:none">Je m'inscrit !</a><br/>
                <a href="forgot.php" id="href" style="font-size:12px; color:#000; text-decoration:none">Mot de passe oublié ?</a>
            </div>
         </center>
	</div>
<?php
